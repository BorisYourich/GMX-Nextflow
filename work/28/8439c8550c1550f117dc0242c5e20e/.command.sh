...
CPT=`find /home/boris/GMX-Nextflow/RE/03/ -name "*.cpt"`
...
gmx grompp -f ${MDP}              -c ${GRO}              -r ${REF} ${CPT}              -p ${TOP}              -n ${NDX}              -o /home/boris/GMX-Nextflow/RE/03/compassionate_watson.tpr -quiet -maxwarn ${MAXWARN}
