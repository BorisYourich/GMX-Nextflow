...
CPT=`find /home/boris/GMX-Nextflow/RE/11/ -name "*.cpt"`
...
gmx grompp -f ${MDP}              -c ${GRO}              -r ${REF} ${CPT}              -p ${TOP}              -n ${NDX}              -o /home/boris/GMX-Nextflow/RE/11/compassionate_watson.tpr -quiet -maxwarn ${MAXWARN}
